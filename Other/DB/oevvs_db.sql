...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/metro/css/theme.css?v=5.1.3&nocache=707069110ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=oevvs_db&table=business_types">`oevvs_db`.`business_types`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=oevvs_db&table=verification_status">`oevvs_db`.`verification_status`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=oevvs_db&table=access">`oevvs_db`.`access`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=kftdb&table=notices">`kftdb`.`notices`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=kftdb&table=logins">`kftdb`.`logins`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=kftdb&table=academic_session_sections">`kftdb`.`academic_session_sections`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=kftdb&table=roles">`kftdb`.`roles`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="4961237e4978395b5f6356643f5c3572">
