...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 03, 2022 at 07:25 PM
...
(2, 'B1654156290010', 'DUMMY', 'DUMMY', '1515217821', 1, 1, 1, 3, 1, '2022-06-03 19:44:58'),
(3, 'B1654156318148', 'DUMMY', 'DUMMY', '1515217821', 1, 1, 1, 4, 1, '2022-06-03 14:56:48'),
(4, 'B1654156318800', 'DUMMY', 'DUMMY', '1515217821', 1, 1, 1, 4, 1, '2022-06-03 19:44:48'),
(5, 'B1654156318988', 'DUMMY', 'DUMMY', '1515217821', 0, 1, 1, 2, 2, '2022-06-03 19:41:09'),
...
(9, 'B1654261762358', 'Colors Hill', 'Shantinagar\nDhaka-1000.\nBangladesh.', '+8801515217777', 1, 1, 1, 1, NULL, '2022-06-03 19:16:16');
...
INSERT INTO `chats` (`id`, `text`, `sender_id`, `reciever_id`, `updated_at`) VALUES
(15, 'Hello', 6, 1, '2022-06-03 23:01:55'),
(16, 'Hello', 6, 1, '2022-06-03 23:02:08'),
(17, 'Hello', 1, 6, '2022-06-03 23:02:16'),
(18, 'Hello', 1, 6, '2022-06-03 23:02:24'),
(19, 'How are you?', 6, 1, '2022-06-03 23:04:24'),
(20, 'I am fine. do you have any query?', 1, 6, '2022-06-03 23:04:48'),
(21, 'Yes.', 6, 1, '2022-06-03 23:05:37'),
(22, 'What is it?', 1, 6, '2022-06-03 23:06:43'),
(23, 'How long it will take to verify my business?', 6, 1, '2022-06-03 23:07:34'),
(24, 'Can you send me your business credentials?', 1, 6, '2022-06-03 23:07:54');
...
(8, 'ananna', 'ghjkl', NULL, 'Female', '2022-06-29', 'A+', '+8801265636768', 14, '2022-06-03 19:38:47'),
(9, 'ashek', 'ashek', NULL, 'Male', '2022-07-01', 'A+', '+8801098765432', 16, '2022-06-03 19:43:03');
...
(7, 'uploads\\verification_uploads\\1654261833612-984996340-Minimum Passing Grade (Online Copy).pdf', 9, '2022-06-03 19:10:33'),
(8, 'uploads\\verification_uploads\\1654263203562-654137351-Ayesha.jpg', 2, '2022-06-03 19:33:23');
...
(10, 'limon@gmail.com', '123456', 'uploads\\avatar\\profile_avatar.png', 2, 3, '2022-06-01 23:24:24', '2022-06-01 23:44:31'),
(12, 'ayesha35-25144rr@diu.edu.bd', '1820904', 'uploads\\avatar\\profile_avatar.png', 3, 3, '2022-06-02 15:23:15', '2022-06-02 15:23:15'),
(14, 'ahghdjhgh@gmail.com', '1410291', 'uploads\\avatar\\profile_avatar.png', 3, 2, '2022-06-03 19:38:47', '2022-06-03 19:39:09'),
(15, '777flyer@gmail.com', '1537411', 'uploads\\avatar\\profile_avatar.png', 2, 3, '2022-06-03 19:40:43', '2022-06-03 19:40:43'),
(16, 'ashek@gmail.com', '1548461', 'uploads\\avatar\\profile_avatar.png', 3, 3, '2022-06-03 19:43:03', '2022-06-03 19:43:27');
...
(2, 'Brinto', 'flyer', 'P1654263643633', 'Male', '2022-06-04', 'A+', '+8801230986754', 15, '2022-06-03 19:40:43');
...
ALTER TABLE `chats`
  ...
  ADD KEY `chats_ibfk_2` (`reciever_id`);
...
--
ALTER TABLE `chats`
  ADD CONSTRAINT `chats_ibfk_1` FOREIGN KEY (`sender_id`) REFERENCES `logins` (`id`),
  ADD CONSTRAINT `chats_ibfk_2` FOREIGN KEY (`reciever_id`) REFERENCES `logins` (`id`);
