$(document).ready(function () {
    ...
    // LOAD TABLE
    var LoadAllPolice = function(){
        var decryptLoginInfo = CryptoJS.AES.decrypt(localStorage.loginInfo, '333');
        decryptLoginInfo = decryptLoginInfo.toString(CryptoJS.enc.Utf8);
        decryptLoginInfo = JSON.parse(decryptLoginInfo);

        $.ajax({
            url: api_base_URL+"/api/polices/get-all-police",
            method: "GET",
            headers : {
    ...
    var InsertLogin = function(data){
        ...
        $.ajax({
            url: api_base_URL+"/api/logins/insert-police",
            method: "POST",
            data : data,
            headers : {
                role : decryptLoginInfo.role_id,
    ...
    // LOAD TABLE
    var LoadAllPoliceByCredential = function(data){
        var decryptLoginInfo = CryptoJS.AES.decrypt(localStorage.loginInfo, '333');
        decryptLoginInfo = decryptLoginInfo.toString(CryptoJS.enc.Utf8);
        decryptLoginInfo = JSON.parse(decryptLoginInfo);

        $.ajax({
            url: api_base_URL+"/api/polices/get-all-police/registered/credential/"+data,
            method: "GET",
            headers : {
                role : decryptLoginInfo.role_id,
            },
    ...
    $("#search").on("keyup change",function(){
        ...
        {
            LoadAllPoliceByCredential($("#search").val());
        }
        else
        {
            LoadAllPolice();
    ...
    var LoadInformation = function(data){
        ...
        $.ajax({
            url: api_base_URL+"/api/polices/get-police/id/"+data,
            method: "GET",
            headers : {
                role : decryptLoginInfo.role_id,
            },
            complete: function (xhr, status) {
                if (xhr.status == 200) {
                   ...
                   $('#update_employee_no').val(data.employee_no);
    ...
    var updateInformation = function (id, data) {
        ...
        $.ajax({
            url: api_base_URL+"/api/polices/update-police/"+id,
            method: "PUT",
            data: data,
            headers : {
                role : decryptLoginInfo.role_id,
